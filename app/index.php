...
$routes = [
    [ "name" => "Tabulation"      , "route" => "/bb-alinsangan-nabua"  ],
...
<head>
    ...
    <title>bb-alinsangan-nabua</title>
</head>
<body>
    ...
    <div class="container d-flex align-items-center justify-content-center" style="min-height: 100vh;" >
        <div>
            <div class="text-center mb-5" >
                ...
                <h1 class="fw-bold" >bb-alinsangan-nabua</h1>
                <p class="fst-italic" >Miss Gay Alinsangan </p>
            </div>
