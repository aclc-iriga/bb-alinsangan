...
3. Clone or download this repository to your XAMPP **htdocs** folder.
   The final path should be `path_to/xampp/htdocs/bb-alinsangan-nabua`.
...
5. Inside [phpMyAdmin](http://localhost/phpmyadmin),
   create a MySQL database named `bb-alinsangan-nabua` and import [bb-alinsangan-nabua.sql](bb-alinsangan-nabua.sql) into it.

6. Open the terminal and navigate to the project directory **bb-alinsangan-nabua**.
...
2. Inside [phpMyAdmin](http://localhost/phpmyadmin),
   create a MySQL database named `test-bb-alinsangan-nabua` and import [bb-alinsangan-nabua.sql](bb-alinsangan-nabua.sql) into it.
...
2. Access the application by visiting `http://[host_name]/bb-alinsangan-nabua`,
   where `host_name` is the **IP address** or **host name** of the server in the network.
   For example:
     - <http://localhost/bb-alinsangan-nabua>
     - <http://192.168.1.99/bb-alinsangan-nabua>


#### Admin Dashboard
Access the **admin dashboard** at <http://localhost/bb-alinsangan-nabua/app>.
